...
public class FindImportantRoomCommand implements Command {

    private FileContext context;
    private Scanner scanner;

    public FindImportantRoomCommand(FileContext context, Scanner scanner) {
    ...
    public void execute() {
        ...
        this.context.getState().findImportant(min,start,end);
